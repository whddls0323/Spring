...
@Repository
public interface User1Repository extends JpaRepository<User1, String> { // <entity, 해당 엔티티의 ID 속성 자료형>
    ...
    @Query("SELECT p, c FROM Parent as p " + "JOIN Child as c ON p.pid = c.pid " + "WHERE p.pid = :pid")
