...
@Getter
//엔티티 관계설정에서 엔티티의 toString()를 호출하면
//관계 속성의 또다른 엔티티의 toString() 호출되기 때문에 엔티티간의 toString()호출로 stackoverflow 에러 발생.
...
public class Article {
    ...
    @CreationTimestamp
    private LocalDateTime wdate; //JPA 현재 날짜시간 클래스, @CreationTimestamp로 현재 날짜시간 처리
}
